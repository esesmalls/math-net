(function () {
  ...
  const results = [
    ...
    result("topology", "recent", "seifert-surfaces-four-ball", "Non-Isotopic Seifert Surfaces in the 4-Ball", "De superficiebus Seifert", "Zsombor Fehér", "2023", "preprint",
      "There are families of knots and links with pairs of Seifert surfaces that are topologically non-isotopic in the 4-ball.",
      "L ⊂ S³: knot or link; F₀,F₁ ⊂ D⁴: Seifert surfaces with common boundary L.",
      "∂F₀ = ∂F₁ = L,  but  F₀ ≄ F₁ rel ∂ in D⁴",
      ["Pass to the double covers of D⁴ branched along the two surfaces.", "Use their Seifert forms to obtain integral binary quadratic forms.", "Apply Conway topographs to decide that the forms, hence the surfaces, are inequivalent."],
      "The result produces systematic four-dimensional non-uniqueness from classical Seifert-form data and an explicit arithmetic decision procedure.",
      [source("Original preprint", "https://arxiv.org/abs/2304.12113", "preprint"), source("AMS knot theory background", "https://www.ams.org/publicoutreach/feature-column/fcarc-knots", "institution")],
    ...
    result("geometry", "recent", "multiplicity-one-mean-curvature", "Multiplicity One for Mean-Curvature Flow", "De fluxu curvatureae mediae", "Richard H. Bamler, Bruce Kleiner", "2023 / 2024", "preprint",
      "Every blow-up limit of a mean-curvature flow of an embedded surface in ℝ³ has multiplicity one.",
      "M_t: surface mean-curvature flow; λ_i(M_{t_i}−x_i): parabolic blow-up sequence.",
      "every tangent flow of M_t ⊂ ℝ³ has multiplicity 1",
      ["Develop a regularity theory for weak flows passing through singularities.", "Analyze separation, discrepancy and fattening for inner and outer flows.", "Exclude higher-sheeted blow-up limits and identify every singularity model with multiplicity one."],
      "The full conjecture controls singular models for arbitrary embedded surface flows and removes an extra hypothesis from the earlier generic-flow theorem.",
      [source("Original preprint", "https://arxiv.org/abs/2312.02106", "preprint"), source("Princeton research lecture", "https://www.math.princeton.edu/events/multiplicity-one-conjecture-mean-curvature-flows-surfaces-2024-04-09t190000", "institution")],
      { motif: "flow", density: 8 }),
    result("geometry", "recent", "compact-bonnet-pairs", "Compact Bonnet Pairs", "De paribus Bonnet", "Alexander I. Bobenko, Tim Hoffmann, Andrew O. Sageman-Furnas", "2025", "published",
      "There exist real-analytic immersed tori in Euclidean 3-space that are isometric and have the same mean-curvature function but are not congruent.",
      "f₁,f₂ : T² → ℝ³; g induced metric; H mean curvature.",
      "g₁ = g₂, H₁ = H₂, but f₁ ≠ A∘f₂",
      ["Relate Bonnet pairs to isothermic surfaces through integrable-system data.", "Construct an isothermic torus with one family of planar curvature lines.", "Apply conformal transformations and close the periods to obtain two real-analytic compact immersions."],
    ...
    result("harmonic", "recent", "restriction-estimates-r3", "Restriction via Decoupling and Two-Ends Furstenberg Inequalities", "De restrictione Fourier", "Hong Wang, Shukun Wu", "2024", "preprint",
      "The decoupling and two-ends Furstenberg method proves a three-dimensional Fourier restriction estimate for every p > 22/7 and implies Wolff's 5/2 hairbrush bound for Kakeya sets in ℝ³.",
      "E: Fourier extension operator; p: spatial Lebesgue exponent; δ: wave-packet scale.",
      "p > 22/7  ⇒  the ℝ³ restriction estimate holds",
      ["Formulate a two-ends Furstenberg inequality that would imply restriction.", "Prove the required planar inequality using the sharp Furstenberg-set estimate.", "Combine it with decoupling to obtain the three-dimensional exponent p > 22/7."],
      "The work gives a direct bridge from fractal incidence geometry and decoupling to improved Fourier restriction.",
      [source("Original preprint", "https://arxiv.org/abs/2411.08871", "preprint"), source("ICM harmonic analysis survey", "https://www.mathunion.org/icm-proceedings", "institution")],
